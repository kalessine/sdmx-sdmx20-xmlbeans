 ...
 */
public class MetadataStructureRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.sdmx.resources.sdmxml.schemas.v20.registry.MetadataStructureRefType
{
    ...
    private static final javax.xml.namespace.QName METADATASTRUCTUREID$4 = 
    ...
    public java.lang.String getMetadataStructureID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(METADATASTRUCTUREID$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public org.sdmx.resources.sdmxml.schemas.v20.common.IDType xgetMetadataStructureID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.common.IDType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.common.IDType)get_store().find_element_user(METADATASTRUCTUREID$4, 0);
            return target;
        }
    }
    ...
    public boolean isSetMetadataStructureID()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(METADATASTRUCTUREID$4) != 0;
        }
    }
    ...
    public void setMetadataStructureID(java.lang.String metadataStructureID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(METADATASTRUCTUREID$4);
            }
    ...
    public void xsetMetadataStructureID(org.sdmx.resources.sdmxml.schemas.v20.common.IDType metadataStructureID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v20.common.IDType)get_store().add_element_user(METADATASTRUCTUREID$4);
            }
    ...
    public void unsetMetadataStructureID()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(METADATASTRUCTUREID$4, 0);
        }
    }
