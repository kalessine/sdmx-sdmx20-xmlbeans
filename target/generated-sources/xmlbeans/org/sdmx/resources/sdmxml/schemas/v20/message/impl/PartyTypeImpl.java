 ...
 */
public class PartyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.sdmx.resources.sdmxml.schemas.v20.message.PartyType
{
    ...
    private static final javax.xml.namespace.QName CONTACT$2 = 
        new javax.xml.namespace.QName("http://www.SDMX.org/resources/SDMXML/schemas/v2_0/message", "Contact");
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.message.ContactType[] getContactArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            org.sdmx.resources.sdmxml.schemas.v20.message.ContactType[] result = new org.sdmx.resources.sdmxml.schemas.v20.message.ContactType[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.message.ContactType getContactArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.message.ContactType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.message.ContactType)get_store().find_element_user(CONTACT$2, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setContactArray(org.sdmx.resources.sdmxml.schemas.v20.message.ContactType[] contactArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setContactArray(int i, org.sdmx.resources.sdmxml.schemas.v20.message.ContactType contact)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.message.ContactType insertNewContact(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.message.ContactType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.message.ContactType)get_store().insert_element_user(CONTACT$2, i);
            return target;
        }
    }
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.message.ContactType addNewContact()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.message.ContactType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.message.ContactType)get_store().add_element_user(CONTACT$2);
            return target;
        }
    }
