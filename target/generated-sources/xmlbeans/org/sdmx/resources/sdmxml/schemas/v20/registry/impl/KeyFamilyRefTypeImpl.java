 ...
 */
public class KeyFamilyRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.sdmx.resources.sdmxml.schemas.v20.registry.KeyFamilyRefType
{
    ...
    public java.lang.String getKeyFamilyID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(KEYFAMILYID$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public org.sdmx.resources.sdmxml.schemas.v20.common.IDType xgetKeyFamilyID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.common.IDType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.common.IDType)get_store().find_element_user(KEYFAMILYID$4, 0);
            return target;
        }
    }
    ...
    public boolean isSetKeyFamilyID()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(KEYFAMILYID$4) != 0;
        }
    }
    ...
    public void xsetKeyFamilyID(org.sdmx.resources.sdmxml.schemas.v20.common.IDType keyFamilyID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v20.common.IDType)get_store().add_element_user(KEYFAMILYID$4);
            }
    ...
    public void unsetKeyFamilyID()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(KEYFAMILYID$4, 0);
        }
    }
