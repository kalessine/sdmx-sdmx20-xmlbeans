 ...
 */
public class AnnotationTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.sdmx.resources.sdmxml.schemas.v20.common.AnnotationType
{
    ...
    private static final javax.xml.namespace.QName ANNOTATIONTITLE$0 = 
        new javax.xml.namespace.QName("http://www.SDMX.org/resources/SDMXML/schemas/v2_0/common", "AnnotationTitle");
    private static final javax.xml.namespace.QName ANNOTATIONTYPE$2 = 
        new javax.xml.namespace.QName("http://www.SDMX.org/resources/SDMXML/schemas/v2_0/common", "AnnotationType");
    private static final javax.xml.namespace.QName ANNOTATIONURL$4 = 
        new javax.xml.namespace.QName("http://www.SDMX.org/resources/SDMXML/schemas/v2_0/common", "AnnotationURL");
    private static final javax.xml.namespace.QName ANNOTATIONTEXT$6 = 
        new javax.xml.namespace.QName("http://www.SDMX.org/resources/SDMXML/schemas/v2_0/common", "AnnotationText");
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.common.TextType[] getAnnotationTextArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.common.TextType getAnnotationTextArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.common.TextType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.common.TextType)get_store().find_element_user(ANNOTATIONTEXT$6, i);
            if (target == null)
            {
     ...
     */
    public void setAnnotationTextArray(org.sdmx.resources.sdmxml.schemas.v20.common.TextType[] annotationTextArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setAnnotationTextArray(int i, org.sdmx.resources.sdmxml.schemas.v20.common.TextType annotationText)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.common.TextType insertNewAnnotationText(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.common.TextType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.common.TextType)get_store().insert_element_user(ANNOTATIONTEXT$6, i);
            return target;
        }
    }
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.common.TextType addNewAnnotationText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.common.TextType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.common.TextType)get_store().add_element_user(ANNOTATIONTEXT$6);
            return target;
        }
    }
