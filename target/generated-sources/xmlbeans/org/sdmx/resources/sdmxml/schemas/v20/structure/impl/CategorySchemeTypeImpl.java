 ...
 */
public class CategorySchemeTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.sdmx.resources.sdmxml.schemas.v20.structure.CategorySchemeType
{
    ...
    public org.sdmx.resources.sdmxml.schemas.v20.structure.CategoryType getCategoryArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (org.sdmx.resources.sdmxml.schemas.v20.structure.CategoryType)get_store().find_element_user(CATEGORY$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public org.sdmx.resources.sdmxml.schemas.v20.structure.CategoryType insertNewCategory(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.structure.CategoryType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.structure.CategoryType)get_store().insert_element_user(CATEGORY$4, i);
            return target;
        }
    }
    ...
    public org.sdmx.resources.sdmxml.schemas.v20.structure.CategoryType addNewCategory()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.structure.CategoryType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.structure.CategoryType)get_store().add_element_user(CATEGORY$4);
            return target;
        }
    }
