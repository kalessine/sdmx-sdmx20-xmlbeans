 ...
 */
public class DataflowRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.sdmx.resources.sdmxml.schemas.v20.registry.DataflowRefType
{
    ...
    public java.lang.String getDataflowID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(DATAFLOWID$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public org.sdmx.resources.sdmxml.schemas.v20.common.IDType xgetDataflowID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.common.IDType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.common.IDType)get_store().find_element_user(DATAFLOWID$4, 0);
            return target;
        }
    }
    ...
    public boolean isSetDataflowID()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DATAFLOWID$4) != 0;
        }
    }
    ...
    public void xsetDataflowID(org.sdmx.resources.sdmxml.schemas.v20.common.IDType dataflowID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v20.common.IDType)get_store().add_element_user(DATAFLOWID$4);
            }
    ...
    public void unsetDataflowID()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(DATAFLOWID$4, 0);
        }
    }
