 ...
 */
public class SubmissionResultTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.sdmx.resources.sdmxml.schemas.v20.registry.SubmissionResultType
{
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.registry.SubmittedStructureType getSubmittedStructure()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.registry.SubmittedStructureType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.registry.SubmittedStructureType)get_store().find_element_user(SUBMITTEDSTRUCTURE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSubmittedStructure(org.sdmx.resources.sdmxml.schemas.v20.registry.SubmittedStructureType submittedStructure)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v20.registry.SubmittedStructureType)get_store().add_element_user(SUBMITTEDSTRUCTURE$0);
            }
    ...
    public org.sdmx.resources.sdmxml.schemas.v20.registry.StatusMessageType getStatusMessage()
    {
        synchronized (monitor())
        {
            ...
            target = (org.sdmx.resources.sdmxml.schemas.v20.registry.StatusMessageType)get_store().find_element_user(STATUSMESSAGE$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setStatusMessage(org.sdmx.resources.sdmxml.schemas.v20.registry.StatusMessageType statusMessage)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v20.registry.StatusMessageType)get_store().add_element_user(STATUSMESSAGE$2);
            }
