 ...
 */
public class CodelistRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.sdmx.resources.sdmxml.schemas.v20.structure.CodelistRefType
{
    ...
    private static final javax.xml.namespace.QName AGENCYID$2 = 
        new javax.xml.namespace.QName("http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", "AgencyID");
    private static final javax.xml.namespace.QName CODELISTID$4 = 
        new javax.xml.namespace.QName("http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", "CodelistID");
    ...
    private static final javax.xml.namespace.QName ALIAS$8 = 
        new javax.xml.namespace.QName("http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", "Alias");
    ...
    public java.lang.String getCodelistID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(CODELISTID$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.common.IDType xgetCodelistID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.common.IDType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.common.IDType)get_store().find_element_user(CODELISTID$4, 0);
            return target;
        }
    }
    ...
    public boolean isSetCodelistID()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CODELISTID$4) != 0;
        }
    }
    ...
    public void setCodelistID(java.lang.String codelistID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(CODELISTID$4);
            }
     ...
     */
    public void xsetCodelistID(org.sdmx.resources.sdmxml.schemas.v20.common.IDType codelistID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v20.common.IDType)get_store().add_element_user(CODELISTID$4);
            }
    ...
    public void unsetCodelistID()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(CODELISTID$4, 0);
        }
    }
    ...
    public java.lang.String getAlias()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(ALIAS$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.common.IDType xgetAlias()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.common.IDType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.common.IDType)get_store().find_element_user(ALIAS$8, 0);
            return target;
        }
    }
    ...
    public boolean isSetAlias()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ALIAS$8) != 0;
        }
    }
    ...
    public void setAlias(java.lang.String alias)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(ALIAS$8);
            }
     ...
     */
    public void xsetAlias(org.sdmx.resources.sdmxml.schemas.v20.common.IDType alias)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v20.common.IDType)get_store().add_element_user(ALIAS$8);
            }
            target.set(alias);
        }
    }
    ...
    public void unsetAlias()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ALIAS$8, 0);
        }
    }
}
