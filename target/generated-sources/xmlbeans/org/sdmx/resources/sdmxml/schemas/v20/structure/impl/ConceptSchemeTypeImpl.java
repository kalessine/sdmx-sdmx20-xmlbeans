 ...
 */
public class ConceptSchemeTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.sdmx.resources.sdmxml.schemas.v20.structure.ConceptSchemeType
{
    ...
    public org.sdmx.resources.sdmxml.schemas.v20.structure.ConceptType getConceptArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (org.sdmx.resources.sdmxml.schemas.v20.structure.ConceptType)get_store().find_element_user(CONCEPT$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public org.sdmx.resources.sdmxml.schemas.v20.structure.ConceptType insertNewConcept(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.structure.ConceptType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.structure.ConceptType)get_store().insert_element_user(CONCEPT$4, i);
            return target;
        }
    }
    ...
    public org.sdmx.resources.sdmxml.schemas.v20.structure.ConceptType addNewConcept()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.structure.ConceptType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.structure.ConceptType)get_store().add_element_user(CONCEPT$4);
            return target;
        }
    }
