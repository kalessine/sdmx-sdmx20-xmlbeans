 ...
 */
public class FullTargetIdentifierTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.sdmx.resources.sdmxml.schemas.v20.structure.FullTargetIdentifierType
{
    private static final long serialVersionUID = 1L;
    
    public FullTargetIdentifierTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName IDENTIFIERCOMPONENT$4 = 
        new javax.xml.namespace.QName("http://www.SDMX.org/resources/SDMXML/schemas/v2_0/structure", "IdentifierComponent");
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType[] getIdentifierComponentArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(IDENTIFIERCOMPONENT$4, targetList);
            org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType[] result = new org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType getIdentifierComponentArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType)get_store().find_element_user(IDENTIFIERCOMPONENT$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public int sizeOfIdentifierComponentArray()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(IDENTIFIERCOMPONENT$4);
        }
    }
     ...
     */
    public void setIdentifierComponentArray(org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType[] identifierComponentArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
            arraySetterHelper(identifierComponentArray, IDENTIFIERCOMPONENT$4);
        }
    }
     ...
     */
    public void setIdentifierComponentArray(int i, org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType identifierComponent)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            target.set(identifierComponent);
        }
    }
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType insertNewIdentifierComponent(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType)get_store().insert_element_user(IDENTIFIERCOMPONENT$4, i);
            return target;
        }
    }
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType addNewIdentifierComponent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.structure.IdentifierComponentType)get_store().add_element_user(IDENTIFIERCOMPONENT$4);
            return target;
        }
    }
    ...
    public void removeIdentifierComponent(int i)
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(IDENTIFIERCOMPONENT$4, i);
        }
    }
