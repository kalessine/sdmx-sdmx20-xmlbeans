 ...
 */
public class MetadataflowRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.sdmx.resources.sdmxml.schemas.v20.registry.MetadataflowRefType
{
    ...
    private static final javax.xml.namespace.QName METADATAFLOWID$4 = 
    ...
    private static final javax.xml.namespace.QName CONSTRAINT$10 = 
     ...
     */
    public java.lang.String getMetadataflowID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(METADATAFLOWID$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v20.common.IDType xgetMetadataflowID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v20.common.IDType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v20.common.IDType)get_store().find_element_user(METADATAFLOWID$4, 0);
            return target;
        }
    }
     ...
     */
    public boolean isSetMetadataflowID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(METADATAFLOWID$4) != 0;
        }
    }
     ...
     */
    public void setMetadataflowID(java.lang.String metadataflowID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(METADATAFLOWID$4);
            }
     ...
     */
    public void xsetMetadataflowID(org.sdmx.resources.sdmxml.schemas.v20.common.IDType metadataflowID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v20.common.IDType)get_store().add_element_user(METADATAFLOWID$4);
            }
     ...
     */
    public void unsetMetadataflowID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(METADATAFLOWID$4, 0);
        }
    }
    ...
    public org.sdmx.resources.sdmxml.schemas.v20.common.ConstraintType getConstraint()
    {
        synchronized (monitor())
        {
            ...
            target = (org.sdmx.resources.sdmxml.schemas.v20.common.ConstraintType)get_store().find_element_user(CONSTRAINT$10, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetConstraint()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CONSTRAINT$10) != 0;
        }
    }
    ...
    public void setConstraint(org.sdmx.resources.sdmxml.schemas.v20.common.ConstraintType constraint)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v20.common.ConstraintType)get_store().add_element_user(CONSTRAINT$10);
            }
    ...
    public void unsetConstraint()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(CONSTRAINT$10, 0);
        }
    }
}
